...
> Answer: Makes a better user experience because there is no load time/refresh between each page of an applicaation. Everything is ran in the browser, so it makes for faster load time overall 
